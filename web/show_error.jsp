...
.cable {
  ...
  linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), linear-gradient(rgba(0,0,0,0.7),
   rgba(0,0,0,0.7));
}
.cover {
  width: 200px;
...
.in-cover .bulb {
    ...
    bottom: -20px;
    margin: 0px auto;
    -webkit-box-shadow: 0 0 15px 7px rgba(0,255,255,0.8), 0 0 40px 25px 
    rgba(0,255,255,0.5), -75px 0 30px 15px rgba(0,255,255,0.2);
        ...
        <section class="error">
            ...
            <div class="error__content">
                <div class="error__message message">
                    <h1 class="message__title">Student Not Found!</h1>
                    <p class="message__text">
                        Type Correctly!
                    </p>
                </div>
                <div class="error__nav e-nav">
                    <a href="show_form_details.jsp" target="_blanck" class="e-nav__link"></a>
                </div>
            </div>
            <!-- END Content -->
        </section>
